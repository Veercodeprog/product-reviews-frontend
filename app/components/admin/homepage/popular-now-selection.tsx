...
export default function PopularNowSelection({
  ...
  return (
    <>
      <div
        className="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 bg-purple-800 hover:bg-purple-900 focus:ring-4 focus:ring-purple-200 rounded-lg p-4 sm:p-6 xl:p-8 cursor-pointer"
      >
        <div
