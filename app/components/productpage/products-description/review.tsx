...
export default function Review({review,parentReviewId,reviews,productId,handlePostReview }:{review:any,parentReviewId:any ,reviews:any,productId:any,handlePostReview:any}){
